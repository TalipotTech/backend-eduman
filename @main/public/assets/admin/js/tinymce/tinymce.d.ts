...
type Categorys_d_ExecCommandEvent = ExecCommandEvent;
type Categorys_d_BeforeGetContentEvent = BeforeGetContentEvent;
type Categorys_d_GetContentEvent = GetContentEvent;
type Categorys_d_BeforeSetContentEvent = BeforeSetContentEvent;
type Categorys_d_SetContentEvent = SetContentEvent;
type Categorys_d_SaveContentEvent = SaveContentEvent;
type Categorys_d_NewBlockEvent = NewBlockEvent;
type Categorys_d_NodeChangeEvent = NodeChangeEvent;
type Categorys_d_FormatEvent = FormatEvent;
type Categorys_d_ObjectResizeEvent = ObjectResizeEvent;
type Categorys_d_ObjectSelectedEvent = ObjectSelectedEvent;
type Categorys_d_ScrollIntoViewEvent = ScrollIntoViewEvent;
type Categorys_d_SetSelectionRangeEvent = SetSelectionRangeEvent;
type Categorys_d_ShowCaretEvent = ShowCaretEvent;
type Categorys_d_SwitchModeEvent = SwitchModeEvent;
type Categorys_d_ChangeEvent = ChangeEvent;
type Categorys_d_AddUndoEvent = AddUndoEvent;
type Categorys_d_UndoRedoEvent = UndoRedoEvent;
type Categorys_d_WindowEvent<T extends DialogData> = WindowEvent<T>;
type Categorys_d_ProgressStateEvent = ProgressStateEvent;
type Categorys_d_AfterProgressStateEvent = AfterProgressStateEvent;
type Categorys_d_PlaceholderToggleEvent = PlaceholderToggleEvent;
type Categorys_d_LoadErrorEvent = LoadErrorEvent;
type Categorys_d_PreProcessEvent = PreProcessEvent;
type Categorys_d_PostProcessEvent = PostProcessEvent;
type Categorys_d_PastePlainTextToggleEvent = PastePlainTextToggleEvent;
type Categorys_d_PastePreProcessEvent = PastePreProcessEvent;
type Categorys_d_PastePostProcessEvent = PastePostProcessEvent;
type Categorys_d_NewTableRowEvent = NewTableRowEvent;
type Categorys_d_NewTableCellEvent = NewTableCellEvent;
type Categorys_d_TableEventData = TableEventData;
type Categorys_d_TableModifiedEvent = TableModifiedEvent;
type Categorys_d_BeforeOpenNotificationEvent = BeforeOpenNotificationEvent;
type Categorys_d_OpenNotificationEvent = OpenNotificationEvent;
type Categorys_d_EditorEventMap = EditorEventMap;
type Categorys_d_EditorManagerEventMap = EditorManagerEventMap;
declare namespace Categorys_d {
    export { Categorys_d_ExecCommandEvent as ExecCommandEvent, Categorys_d_BeforeGetContentEvent as BeforeGetContentEvent, Categorys_d_GetContentEvent as GetContentEvent, Categorys_d_BeforeSetContentEvent as BeforeSetContentEvent, Categorys_d_SetContentEvent as SetContentEvent, Categorys_d_SaveContentEvent as SaveContentEvent, Categorys_d_NewBlockEvent as NewBlockEvent, Categorys_d_NodeChangeEvent as NodeChangeEvent, Categorys_d_FormatEvent as FormatEvent, Categorys_d_ObjectResizeEvent as ObjectResizeEvent, Categorys_d_ObjectSelectedEvent as ObjectSelectedEvent, Categorys_d_ScrollIntoViewEvent as ScrollIntoViewEvent, Categorys_d_SetSelectionRangeEvent as SetSelectionRangeEvent, Categorys_d_ShowCaretEvent as ShowCaretEvent, Categorys_d_SwitchModeEvent as SwitchModeEvent, Categorys_d_ChangeEvent as ChangeEvent, Categorys_d_AddUndoEvent as AddUndoEvent, Categorys_d_UndoRedoEvent as UndoRedoEvent, Categorys_d_WindowEvent as WindowEvent, Categorys_d_ProgressStateEvent as ProgressStateEvent, Categorys_d_AfterProgressStateEvent as AfterProgressStateEvent, Categorys_d_PlaceholderToggleEvent as PlaceholderToggleEvent, Categorys_d_LoadErrorEvent as LoadErrorEvent, Categorys_d_PreProcessEvent as PreProcessEvent, Categorys_d_PostProcessEvent as PostProcessEvent, Categorys_d_PastePlainTextToggleEvent as PastePlainTextToggleEvent, Categorys_d_PastePreProcessEvent as PastePreProcessEvent, Categorys_d_PastePostProcessEvent as PastePostProcessEvent, Categorys_d_NewTableRowEvent as NewTableRowEvent, Categorys_d_NewTableCellEvent as NewTableCellEvent, Categorys_d_TableEventData as TableEventData, Categorys_d_TableModifiedEvent as TableModifiedEvent, Categorys_d_BeforeOpenNotificationEvent as BeforeOpenNotificationEvent, Categorys_d_OpenNotificationEvent as OpenNotificationEvent, Categorys_d_EditorEventMap as EditorEventMap, Categorys_d_EditorManagerEventMap as EditorManagerEventMap, };
}
