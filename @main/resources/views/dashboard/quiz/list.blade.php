...
@section('title') {{ __("All Quizzes") }} @endsection
...
@section('content')
    <div class="dashboard-edit">
        <div class="mb-10">
            <h4 class="dashboard-edit-title mb-6">{{ __("All Quizzes") }}</h4>
            <x-common.top-btn :text="__('New Quiz')" href="{{ route('dashboard.quiz.new') }}" />
        </div>
