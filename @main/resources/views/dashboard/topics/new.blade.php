...
@section('title') {{ __("Create Topic") }} @endsection
...
<div class="dashboard-edit flex justify-between items-center py-3">
    <h4 class="dashboard-edit-title mb-1">{{ __("Create Topic") }}</h4>
    <x-common.top-btn :icon="'fa-bars'" :text="__('All Topics')" class="mb-0" href="{{ route('dashboard.topics.list') }}" />
</div>

<form method="POST" action="{{ route('dashboard.topics.new') }}" enctype="multipart/form-data">
    @csrf
