            ...
            <div class="dashboard-edit p-10">
                <div class="eduman-select-field mb-5">
                    ...
                    <div class="eduman-input-field-style">
                        <div class="single-input-field w-full">
                            <x-text-input id="title" name="title" :value="$page->title" class="block mt-1 w-full" type="text" required autofocus />
                        </div>
                    </div>
                ...
                <div class="col-span-12">
                    <div class="eduman-select-field mb-5">
                        ...
                        <div class="eduman-input-field-style">
                            <div class="single-input-field w-full">
                                <x-tinymce.editor :id="'content'" :name="'content'" :type="'html'" :value="$page->content" />
                            </div>
                        </div>
                ...
                <div class="col-span-12">
                    <div class="eduman-select-field mb-5">
                        ...
                        <div class="eduman-input-field-style">
                            <div class="single-input-field w-full">
                                <x-text-input id="meta_title" name="meta_title" :value="$page->meta_title" class="block mt-1 w-full" type="text" required />
                            </div>
                        </div>
                ...
                <div class="col-span-12">
                    <div class="eduman-select-field mb-5">
                        ...
                        <div class="eduman-input-field-style">
                            <div class="single-input-field w-full">
                                <textarea name="meta_description" id="meta_description" cols="30" rows="10">{{ $page->meta_description }}</textarea>
                            </div>
                        </div>
                ...
                <div class="eduman-select-field mb-8">
                    ...
                    @if($page->meta_image)
                        <img src="{{ uploaded_asset($page->meta_image) }}" alt="">
                    @endif
                </div>
            </div>
        </div>
            ...
            <div class="dashboard-edit">
                    ...
                    <div class="eduman-radio-field-style">
                        <div class="single-input-field w-full">
                            <label for="opt-1" class="mr-4">
                                <input class="mr-1" type="radio" @checked($page->status->value == 'Active') name="status" id="opt-1" value="Active" />
                                {{ __("Published") }}
                            </label>
                            <label for="opt-2" class="mr-4">
                                <input class="mr-1" type="radio" @checked($page->status->value == 'Pending') name="status" id="opt-2" value="Pending" />
                                {{ __("Pending") }}
                            </label>
                        </div>
                    </div>
                ...
                <div class="col-span-12 mt-12">
                    <div class="eduman-managesale-top-btn default-light-theme justify-center">
                        <button class="btn-primary" type="submit">{{ __("Update Page") }}</button>
                    </div>
                </div>
            </div>
        </div>
