...
<form method="POST" action="{{ route('dashboard.settings.page.home-02.cta_02') }}" enctype="multipart/form-data">
    @csrf
    <div class="grid grid-cols-12 sm:gap-x-5">
        <div class="lg:col-span-12 md:col-span-12 col-span-12">
            <div class="dashboard-edit p-10">
                @include("partials.inputs.input", [
                    "label" => __("home_02_cta_02_title"),
                    "name" => "home_02_cta_02_title",
                    "type" => "text",
                    "value" => $options["home_02_cta_02_title"] ?? "",
                ])
                @include("partials.inputs.input", [
                    "label" => __("home_02_cta_02_subtitle"),
                    "name" => "home_02_cta_02_subtitle",
                    "type" => "text",
                    "value" => $options["home_02_cta_02_subtitle"] ?? "",
                ])
                @include("partials.inputs.input", [
                    "label" => __("home_02_cta_02_btn_text"),
                    "name" => "home_02_cta_02_btn_text",
                    "type" => "text",
                    "value" => $options["home_02_cta_02_btn_text"] ?? "",
                ])
                @include("partials.inputs.input", [
                    "label" => __("home_02_cta_02_btn_url"),
                    "name" => "home_02_cta_02_btn_url",
                    "type" => "text",
                    "value" => $options["home_02_cta_02_btn_url"] ?? "",
                ])
                @include("partials.inputs.file", [
                    "label" => __("home_02_cta_02_img_01"),
                    "name" => "home_02_cta_02_img_01",
                    "value" => $options["home_02_cta_02_img_01"] ?? "",
                ])
                @include("partials.inputs.file", [
                    "label" => __("home_02_cta_02_img_02"),
                    "name" => "home_02_cta_02_img_02",
                    "value" => $options["home_02_cta_02_img_02"] ?? "",
                ])
