...
@php
$page_title = __("Homepage-02 Courses");
@endphp
...
<form method="POST" action="{{ route('dashboard.settings.page.home-02.course') }}" enctype="multipart/form-data">
    @csrf
    <div class="grid grid-cols-12 sm:gap-x-5">
        <div class="lg:col-span-12 md:col-span-12 col-span-12">
            <div class="dashboard-edit p-10">
                @include("partials.inputs.input", [
                    "label" => __("home_02_course_section_title"),
                    "name" => "home_02_course_section_title",
                    "type" => "text",
                    "value" => !empty($options["home_02_course_section_title"])
                                ? str_replace("<br/>", "[br]", $options["home_02_course_section_title"])
                                : "",
