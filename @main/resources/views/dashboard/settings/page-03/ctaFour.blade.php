...
@php
$page_title = __("Homepage-03 Call-to-Action 03");
@endphp
...
<form method="POST" action="{{ route('dashboard.settings.page.home-03.cta_04') }}" enctype="multipart/form-data">
    @csrf
    <div class="grid grid-cols-12 sm:gap-x-5">
        <div class="lg:col-span-12 md:col-span-12 col-span-12">
            <div class="dashboard-edit p-10">
                @include("partials.inputs.input", [
                    "label" => __("home_03_cta_04_subtitle"),
                    "name" => "home_03_cta_04_subtitle",
                    "type" => "text",
                    "value" => $options["home_03_cta_04_subtitle"] ?? "",
                ])
                @include("partials.inputs.input", [
                    "label" => __("home_03_cta_04_title"),
                    "name" => "home_03_cta_04_title",
                    "type" => "text",
                    "value" => $options["home_03_cta_04_title"] ?? "",
                ])
                @include("partials.inputs.input", [
                    "label" => __("home_03_cta_04_btn_text"),
                    "name" => "home_03_cta_04_btn_text",
                    "type" => "text",
                    "value" => $options["home_03_cta_04_btn_text"] ?? "",
                ])
                @include("partials.inputs.input", [
                    "label" => __("home_03_cta_04_btn_url"),
                    "name" => "home_03_cta_04_btn_url",
                    "type" => "text",
                    "value" => $options["home_03_cta_04_btn_url"] ?? "",
                ])
                @include("partials.inputs.file", [
                    "label" => __("home_03_cta_04_img"),
                    "name" => "home_03_cta_04_img",
                    "value" => $options["home_03_cta_04_img"] ?? "",
                ])
                @include("partials.inputs.input", [
                    "label" => __("home_03_cta_04_badge_text"),
                    "name" => "home_03_cta_04_badge_text",
                    "type" => "text",
                    "value" => $options["home_03_cta_04_badge_text"] ?? "",
                ])
