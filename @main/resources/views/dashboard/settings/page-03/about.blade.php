...
@php
$page_title = __("Homepage-03 About");
@endphp
...
<form method="POST" action="{{ route('dashboard.settings.page.home-03.about') }}" enctype="multipart/form-data">
    @csrf
    <div class="grid grid-cols-12 sm:gap-x-5">
        <div class="lg:col-span-12 md:col-span-12 col-span-12">
            <div class="dashboard-edit p-10">
                @include("partials.inputs.input", [
                    "label" => __("home_03_about_title"),
                    "name" => "home_03_about_title",
                    "type" => "text",
                    "value" => $options["home_03_about_title"] ?? "",
                ])
                @include("partials.inputs.input", [
                    "label" => __("home_03_about_badge_title"),
                    "name" => "home_03_about_badge_title",
                    "type" => "text",
                    "value" => $options["home_03_about_badge_title"] ?? "",
                ])
                @include("partials.inputs.file", [
                    "label" => __("home_03_about_image"),
                    "name" => "home_03_about_image",
                    "value" => $options["home_03_about_image"] ?? "",
                ])
                @include("partials.inputs.file", [
                    "label" => __("home_03_about_badge_image"),
                    "name" => "home_03_about_badge_image",
                    "value" => $options["home_03_about_badge_image"] ?? "",
                ])
                @include("partials.inputs.textarea", [
                    "label" => __("home_03_about_description"),
                    "name" => "home_03_about_description",
                    "type" => "html",
                    "value" => $options["home_03_about_description"] ?? "",
                ])
