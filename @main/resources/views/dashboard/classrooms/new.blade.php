...
@section('title') {{ __("Create Class") }} @endsection
...
@section('breadcrumb')
    @include('layouts.breadcrumb', ["path_array" => [
        ...
        __("Class") => route("dashboard.quiz.list"),
        __("Create Class") => ""
    ]])
@endsection
...
<div class="dashboard-edit flex justify-between items-center py-3">
    <h4 class="dashboard-edit-title mb-1">{{ __("Create Class") }}</h4>
    <x-common.top-btn :icon="'fa-bars'" :text="__('All Classes')" class="mb-0" href="{{ route('dashboard.classrooms.list') }}" />
</div>
<form method="POST" action="{{ route('dashboard.classrooms.new') }}" enctype="multipart/form-data">
    @csrf
    <div class="grid grid-cols-12 sm:gap-x-5">
        <div class="lg:col-span-8 col-span-12">
            <div class="dashboard-edit p-10">
                <div class="eduman-select-field mb-5">
                    <h5 class="text-[15px] text-heading font-semibold mb-3">{{ __("Class Title") }}</h5>
